...
NA1=2;
A1H=20; %A1 Reads High
A1L=21; %A1 Reads Low
TLA1=[1 A1H 2;2 A1L 1];
XmA1=1;
A1=automaton(NA1,TLA1,XmA1);
...
Systemautomata=sync(V2,V1,V3,A1,F2,F1,local,master,PSU,F1V1,F2V2V3,A1PSUF1);
...
SPEC1=selfloop(SPEC1,[A1H,A1L,V1O,V1C,V2O,V2C,V3O,V3C]);

UC=[A1H,A1L,F2H,F2L,F1L,F1H,SUS,SDS];
Supervisor1=supcon(SPEC1,Systemautomata,UC)
